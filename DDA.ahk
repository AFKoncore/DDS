...
v:=200315 ;Script version, yearmonthday
...
;___
;TODO: error log. wait 2 buildphase after warmup?. close chat before G. Spam repair at build phase? Read wave number at PopUp() at wave14. warning if unsupported res
